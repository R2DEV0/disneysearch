        ...
        <div className='row mt-5 mb-5'>
          <div className='col-sm-10 offset-sm-1'>
            <div className='input-group'>
              <input className='form-control searchBox col-sm-10' onChange={setFilterText(e)} type={Text} placeholder="Search By Character Name..." aria-describedby="button-addon"/>
