        ...
        <div className='row'>
          {loaded && 
            <div className='resultsContainer col-sm-12' style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}}>
              {searchResults.map((item, i) => { return <div key={i} className="col-lg-4 col-md-5 col-sm-12" style={{height: '500px', border: '1px solid gray', margin: '15px', borderRadius: '5px', boxShadow: '3px 3px 5px gray'}}>
