        ...
        <div className='row mt-5 mb-5'>
          <div className='col-sm-10 offset-sm-1'>
            <div className='input-group'>
              <input className='form-control searchBox' onChange={FilterTextHandler} type={Text} value={Filter} placeholder="Search By Character Name..."/>
              <button className='btn btn-primary col-sm-2' onClick={SearchByName}> SEARCH </button>
              <button className='btn btn-warning col-sm-2' onClick={SearchByName}> CLEAR </button>
            </div>
          </div>
        </div>
