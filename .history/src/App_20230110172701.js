        ...
        <div className='row'>
          {loaded && 
            <div className='resultsContainer col-sm-12' style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}}>
              {searchResults.map((item, i) => { return <div key={i} className="col-lg-3 col-md-5 col-12" style={{minheight: '500px', border: '1px solid gray', margin: '8px', padding: borderRadius: '5px', boxShadow: '3px 3px 5px gray'}}>
