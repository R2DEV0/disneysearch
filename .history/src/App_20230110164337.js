        ...
        <div className='row text-center'>
          {loaded && 
            <div className='resultsContainer col-sm-12'>
              {searchResults.map((item, i) => { return <div key={i} className="col-sm-3" style={{display: 'inline-block', height: '500px', border: '1px solid black', padding:'10px 10px 10px ', margin: '15px'}}>
