        ...
        <div className='row mt-5 mb-5'>
          <div className='col-sm-10 offset-sm-1'>
            <div className='input-group'>
              <input className='form-control searchBox col-sm-8' type={Text} placeholder="Search By Character Name..." aria-describedby="button-addon"/>
              <button className='btn btn-primary col-sm-3' id="button-addon"> SEARCH </button>
            </div>
          </div>
        </div>
