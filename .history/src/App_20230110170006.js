...
function App() {
  ...
  //#region useEffect - Search All Initial Function
  useEffect(() => {
    let results = [];
        ...
        <div className='row mt-5 mb-5'>
          <div className='col-sm-10 offset-sm-1'>
            <div className='input-group'>
              <input className='form-control searchBox col-sm-10' onChange={FilterTextHandler} type={Text} placeholder="Search By Character Name..." aria-describedby="button-addon"/>
              <button className='btn btn-primary col-sm-2' id="button-addon" onClick={FilterSearch()}> SEARCH </button>
            </div>
          </div>
        </div>
